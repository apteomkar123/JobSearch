...
async function buildResumePDF(job, summaryText) {
  ...
  const bp = {
    ...
    ai:       'Deployed AI agents for regulatory research using Python and GitHub Copilot — cuts permit condition lookup time from hours to minutes and runs in a live production environment',
